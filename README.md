...
Completes onboarding to define business type, audience, and brand style
Follows the 7-step campaign wizard, filling in campaign details
AI enhances descriptions and generates voice transcripts
System generates TTS audio and uploads to cloud storage
User uploads contact list
Reviews campaign preview with all assets
Launches campaign with one click
Campaign Execution
Campaign is persisted to Firestore with all details and media
Contact list is processed and stored
Inbox structure is created for each contact
Messages are auto-generated from campaign content
Users can access the inbox to view conversations
Real-time messaging between organization and contacts
AI responds to contact inquiries based on campaign context
Analytics are updated in real-time
Inbox Messaging
User navigates to launched campaign in inbox
Selects a contact from the list
Views conversation history with campaign messages
Can listen to audio messages with interactive player
Can view attached images and videos
Types and sends custom responses
AI automatically responds based on campaign knowledge
All messages are logged for analytics
🎨 Technology Stack
Frontend & Framework
